...
> [!example] Seeded note
> A paper note: a `source`, the authors, year and venue, and what I take from it. Graduated into the bundle as `sources/vaswani-2017-attention-is-all-you-need` (the exhibition vault, beside this one) - a `Reference` record there, which other records cite.
