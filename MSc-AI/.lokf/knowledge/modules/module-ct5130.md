---
type: Module
id: "https://msc-ai.example/knowledge/modules/module-ct5130"
title: Agents, Multi-Agent Systems and Reinforcement Learning - Online
description: CT5130, a curriculum entry in programme 1MAO3. ECTS not yet confirmed.
...
# Agents, Multi-Agent Systems and Reinforcement Learning - Online

Agents, Multi-Agent Systems and Reinforcement Learning - Online is an official curriculum entry in the supplied 2026 programme extract. Semester, year and ECTS remain unset unless explicitly supported by the reviewed source. Detailed learning outcomes, assessment weighting, prerequisites and reading lists are delegated to the offline acquisition workflow.
...
- **isPartOf:** [https://msc-ai.example/knowledge/programme/programme-uog-1mao3](../programme/programme-uog-1mao3.md)
