---
type: Module
id: "https://msc-ai.example/knowledge/modules/module-ct5146"
title: Introduction to Natural Language Processing - Online
description: CT5146, a curriculum entry in programme 1MAO3. ECTS not yet confirmed.
...
# Introduction to Natural Language Processing - Online

Introduction to Natural Language Processing - Online is an official curriculum entry in the supplied 2026 programme extract. Semester, year and ECTS remain unset unless explicitly supported by the reviewed source. Detailed learning outcomes, assessment weighting, prerequisites and reading lists are delegated to the offline acquisition workflow.
